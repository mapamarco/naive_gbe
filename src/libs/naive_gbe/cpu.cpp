...
namespace naive_gbe
{
	...
	lr35902::lr35902(mmu& mmu, ppu& ppu)
		: mmu_(mmu)
		, ppu_(ppu)
	{
		reset();
	...
	lr35902::state lr35902::get_state() const
	{
		return state_;
	}
	...
	std::size_t lr35902::get_cycle() const
	{
		return cycle_;
	}

	std::uint8_t lr35902::get_ime() const
	{
		return ime_;
	}

	std::uint8_t lr35902::get_flags() const
	{
		return registers_[(std::uint8_t)r8::F] & 0xf0;
	}

	bool lr35902::get_flag(flags flag) const
	{
		return registers_[(std::uint8_t)r8::F] & flag;
	}

	std::uint8_t lr35902::get_register(r8 index) const
	{
		return registers_[(std::uint8_t)index];
	}

	std::uint16_t lr35902::get_register(r16 index) const
	{
		return registers_[(std::uint8_t)index] << 8 | registers_[(std::uint8_t)index + 1];
	}

	void lr35902::step(operations& ops, bool extended)
	{
	...
	std::int8_t lr35902::fetch_i8()
	{
		return fetch_u8();
	}

	std::uint16_t lr35902::fetch_u16()
	{
		std::uint16_t addr = get_register(r16::PC);
	...
	void lr35902::set_register(r8 index, std::uint8_t value)
	{
		registers_[(std::uint8_t)index] = value;
	}

	void lr35902::set_register(r16 index, std::uint16_t value)
	{
		registers_[(std::uint8_t)index + 1] = value & 0x00ff;
		registers_[(std::uint8_t)index] = value >> 8;
	}

	auto lr35902::get_ref(r8 reg)
	{
	...
	std::uint8_t lr35902::swap_nibbles(std::uint8_t value) const
	{
		return (value & 0x0f) << 4 | (value & 0xf0) >> 4;
	}

	void lr35902::set_zero_flag(std::uint8_t value, std::uint8_t& flags)
	{
		if (!value)
			flags |= flags::ZERO;
	}

	void lr35902::set_half_carry_and_zero_flags(std::uint8_t value, std::uint8_t& flags)
	{
		if (value & bits::B4)
	...
	void lr35902::call_addr(std::uint16_t addr)
	{
	...
	void lr35902::logical_and(std::uint8_t& rhs, std::uint8_t lhs, std::uint8_t& flags)
	{
		rhs &= lhs;
		flags = flags::HALF_CARRY;
	...
	void lr35902::logical_or(std::uint8_t& lhs, std::uint8_t rhs, std::uint8_t& flags)
	{
		lhs |= rhs;
		flags = 0;
	...
	void lr35902::logical_xor(std::uint8_t& lhs, std::uint8_t rhs, std::uint8_t& flags)
	{
		lhs ^= rhs;
		flags = 0;
		set_zero_flag(lhs, flags);
	...
	void lr35902::test_bit(std::uint8_t bit, std::uint8_t value, std::uint8_t& flags)
	{
	...
	void lr35902::set_carry_flags_sub(std::uint8_t lhs, std::uint8_t rhs, std::uint8_t carry, std::uint8_t& flags)
	{
		if (rhs + carry > lhs)
			flags |= flags::CARRY;
	...
	void lr35902::set_carry_flags_add(std::uint16_t lhs, std::uint16_t rhs, std::uint8_t& flags)
	{
		if (lhs + rhs & 0x10000)
			flags |= flags::CARRY;
	...
	void lr35902::compare(std::uint8_t lhs, std::uint8_t rhs, std::uint8_t& flags)
	{
	...
	void lr35902::sub(std::uint8_t& lhs, std::uint8_t rhs, std::uint8_t carry, std::uint8_t& flags)
	{
		flags = flags::SUBTRACTION;
	...
	void lr35902::set_operation_table()
	{
		auto& ops = ops_;
	...
	void lr35902::set_operation_table_cb()
	{
		auto& ops = ops_cb_;
		ops.assign(0x100, operation{ 1, 4, std::bind(&lr35902::op_undefined, this) });
	...
	// 1 4
	// Z - 0 C
	void lr35902::op_daa(std::uint8_t& lhs, std::uint8_t& flags)
	{
	...
	// 1 4
	// 0 0 0 C
	void lr35902::op_rla(std::uint8_t& lhs, std::uint8_t& flags)
	{
	...
	// 1 4
	// 0 0 0 C
	void lr35902::op_rlca(std::uint8_t& lhs, std::uint8_t& flags)
	{
	...
	// 1 4
	// 0 0 0 C
	void lr35902::op_rra(std::uint8_t& lhs, std::uint8_t& flags)
	{
	...
	// 1 4
	// 0 0 0 C
	void lr35902::op_rrca(std::uint8_t& lhs, std::uint8_t& flags)
	{
	...
	// 1 12
	// - - - -
	void lr35902::op_pop(std::uint8_t& high, std::uint8_t& low)
	{
	...
	// 1 16
	// - - - -
	void lr35902::op_push(std::uint8_t high, std::uint8_t low)
	{
		std::uint16_t addr = get_register(r16::SP);
	...
	// 1 16
	// - - - -
	void lr35902::op_rst(std::uint16_t addr)
	{
		call_addr(addr);
	}
	...
	// 1 20/8
	// - - - -
	void lr35902::op_ret_cond(std::uint8_t flags, std::uint8_t bit, bool state)
	{
	...
	// 3 24/12
	// - - - -
	void lr35902::op_call_cond(std::uint8_t flags, std::uint8_t bit, bool state)
	{
	...
	// 3 16/12
	// - - - -
	void lr35902::op_jp_cond(std::uint8_t flags, std::uint8_t bit, bool state)
	{
		std::int8_t offset = fetch_i8();
	...
	// 2 12/8
	// - - - -
	void lr35902::op_jr_cond(std::uint8_t flags, std::uint8_t bit, bool state)
	{
		std::int8_t offset = fetch_i8();
	...
	// 1 4
	// - - - -
	void lr35902::op_cpl(std::uint8_t& reg, std::uint8_t& flags)
	{
		reg = ~reg;
	...
	// 1 4
	// - 0 0 1
	void lr35902::op_scf(std::uint8_t& flags)
	{
	...
	// 1 4
	// - 0 0 1
	void lr35902::op_ccf(std::uint8_t& flags)
	{
	...
	// 2 16
	// 0 0 H C
	void lr35902::op_add_sp_u8(std::uint8_t& flags)
	{
	...
	// 2 8
	// Z 0 H C
	void lr35902::op_add_d8(std::uint8_t& reg, std::uint8_t& flags)
	{
	...
	// 1 4
	// Z 0 H C
	void lr35902::op_add_r8(std::uint8_t& lhs, std::uint8_t& rhs, std::uint8_t& flags)
	{
		add(lhs, rhs, 0, flags);
	}
	...
	// 2 8
	// Z 0 H C
	void lr35902::op_add_r8_hl(std::uint8_t& lhs, std::uint8_t& flags)
	{
	...
	// 1 8
	// - 0 H C
	void lr35902::op_add_hl_r16(r16 reg, std::uint8_t& flags)
	{
	...
	// 2 8
	// Z 0 H C
	void lr35902::op_adc_d8(std::uint8_t& lhs, std::uint8_t& flags)
	{
	...
	// 1 4
	// Z 0 H C
	void lr35902::op_adc_r8(std::uint8_t& lhs, std::uint8_t& rhs, std::uint8_t& flags)
	{
		std::uint8_t carry = flags & flags::CARRY ? 1 : 0;
	...
	// 2 8
	// Z 0 H C
	void lr35902::op_adc_hl(std::uint8_t& reg, std::uint8_t& flags)
	{
		std::uint8_t carry = flags & flags::CARRY ? 1 : 0;
	...
	// 2 8
	// Z 1 H C
	void lr35902::op_sub_d8(std::uint8_t& reg, std::uint8_t& flags)
	{
	...
	// 1 4
	// Z 1 H C
	void lr35902::op_sub_r8(std::uint8_t& lhs, std::uint8_t& rhs, std::uint8_t& flags)
	{
		sub(lhs, rhs, 0, flags);
	}
	...
	// 2 8
	// Z 0 H C
	void lr35902::op_sub_hl(std::uint8_t& reg, std::uint8_t& flags)
	{
	...
	// 2 8
	// Z 1 H C
	void lr35902::op_sbc_d8(std::uint8_t& lhs, std::uint8_t& flags)
	{
		std::uint8_t carry = flags & flags::CARRY ? 1 : 0;
	...
	// 1 4
	// Z 1 H C
	void lr35902::op_sbc_r8(std::uint8_t& lhs, std::uint8_t& rhs, std::uint8_t& flags)
	{
		std::uint8_t carry = flags & flags::CARRY ? 1 : 0;
	...
	// 1 8
	// Z 1 H C
	void lr35902::op_sbc_hl(std::uint8_t& lhs, std::uint8_t& flags)
	{
		std::uint8_t carry = flags & flags::CARRY ? 1 : 0;
	...
	// 1 4
	// Z 0 H -
	void lr35902::op_inc_r8(std::uint8_t& reg, std::uint8_t& flags)
	{
		increment(reg, flags);
	}
	...
	// 1 12
	// Z 0 H -
	void lr35902::op_inc_hl(std::uint8_t& flags)
	{
	...
	// 1 8
	// - - - -
	void lr35902::op_inc_r16(r16 reg)
	{
	...
	// 1 4
	// Z 1 H -
	void lr35902::op_dec_r8(std::uint8_t& reg, std::uint8_t& flags)
	{
		decrement(reg, flags);
	}
	...
	// 1 12
	// Z 1 H -
	void lr35902::op_dec_hl(std::uint8_t& flags)
	{
	...
	// 1 8
	// - - - -
	void lr35902::op_dec_r16(r16 reg)
	{
		set_register(reg, get_register(reg) - 1);
	}
	...
	// 2 8
	// Z 0 0 0
	void lr35902::op_xor_d8(std::uint8_t& lhs, std::uint8_t& flags)
	{
	...
	// 1 4
	// Z 0 0 0
	void lr35902::op_xor_r8(std::uint8_t& lhs, std::uint8_t rhs, std::uint8_t& flags)
	{
	...
	// 1 8
	// Z 0 0 0
	void lr35902::op_xor_hl(std::uint8_t& reg, std::uint8_t& flags)
	{
		reg ^= get_hl_ref();
		flags = 0;
	...
	// 2 8
	// Z 0 1 0
	void lr35902::op_and_d8(std::uint8_t& rhs, std::uint8_t& flags)
	{
	...
	// 1 4
	// Z 0 1 0
	void lr35902::op_and_r8(std::uint8_t& rhs, std::uint8_t lhs, std::uint8_t& flags)
	{
	...
	// 1 8
	// Z 0 1 0
	void lr35902::op_and_hl(std::uint8_t& reg, std::uint8_t& flags)
	{
		reg &= get_hl_ref();
		flags = flags::HALF_CARRY;
		set_zero_flag(reg, flags);
	...
	// 2 8
	// Z 0 0 0
	void lr35902::op_or_d8(std::uint8_t& lhs, std::uint8_t& flags)
	{
	...
	// 1 4
	// Z 0 0 0
	void lr35902::op_or_r8(std::uint8_t& lhs, std::uint8_t rhs, std::uint8_t& flags)
	{
	...
	// 1 8
	// Z 0 0 0
	void lr35902::op_or_hl(std::uint8_t& reg, std::uint8_t& flags)
	{
		reg |= get_hl_ref();
		flags = 0;
		set_zero_flag(reg, flags);
	...
	// 2 8
	// Z 1 H C
	void lr35902::op_cp_d8(std::uint8_t& lhs, std::uint8_t& flags)
	{
	...
	// 1 4
	// Z 1 H C
	void lr35902::op_cp_r8(std::uint8_t& lhs, std::uint8_t rhs, std::uint8_t& flags)
	{
	...
	// 1 8
	// Z 1 H C
	void lr35902::op_cp_hl(std::uint8_t& reg, std::uint8_t& flags)
	{
	...
	// 1 8
	// - - - -
	void lr35902::op_ld_bc_r8(std::uint8_t& reg)
	{
	...
	// 1 8
	// - - - -
	void lr35902::op_ld_de_r8(std::uint8_t& reg)
	{
	...
	// 1 4
	// - - - -
	void lr35902::op_ld_r8(std::uint8_t& reg)
	{
		reg = fetch_u8();
	}
	...
	// 1 8
	// - - - -
	void lr35902::op_ld_r8_bc(std::uint8_t& reg)
	{
	...
	// 2 8
	// - - - -
	void lr35902::op_ld_c_r8(std::uint8_t lhs, std::uint8_t rhs)
	{
		mmu_[0xff00 + lhs] = rhs;
	}
	...
	// 2 8
	// - - - -
	void lr35902::op_ld_r8_c(std::uint8_t& lhs, std::uint8_t rhs)
	{
		lhs = mmu_[0xff00 + rhs];
	}
	...
	// 1 8
	// - - - -
	void lr35902::op_ld_r8_de(std::uint8_t& reg)
	{
	...
	// 1 4
	// - - - -
	void lr35902::op_ld_r8_r8(std::uint8_t& rhs, std::uint8_t& lhs)
	{
		rhs = lhs;
	}
	...
	// 1 8
	// - - - -
	void lr35902::op_ld_r8_hl(std::uint8_t& reg)
	{
		reg = get_hl_ref();
	}
	...
	// 3 12
	// - - - -
	void lr35902::op_ld_a16_r8(std::uint8_t& reg)
	{
		mmu_[fetch_u16()] = reg;
	}
	...
	// 3 12
	// - - - -
	void lr35902::op_ld_r8_a16(std::uint8_t& reg)
	{
		reg = mmu_[fetch_u16()];
	}
	...
	// 3 12
	// - - - -
	void lr35902::op_ld_r16(r16 reg)
	{
	...
	// 1 8
	// - - - -
	void lr35902::op_ld_hl_r8(std::uint8_t& reg)
	{
		get_hl_ref() = reg;
	}
	...
	// 1 8
	// - - - -
	void lr35902::op_ldi_hl(std::uint8_t& reg)
	{
	...
	// 1 8
	// - - - -
	void lr35902::op_ldi_r8(std::uint8_t& reg)
	{
		std::uint16_t addr = get_register(r16::HL);
	...
	// 2 8
	// Z 0 0 C
	void lr35902::op_rlc_r8(std::uint8_t& reg, std::uint8_t& flags)
	{
	...
	// 2 16
	// Z 0 0 C
	void lr35902::op_rlc_hl(std::uint8_t& flags)
	{
	...
	// 2 8
	// Z 0 0 C
	void lr35902::op_rrc_r8(std::uint8_t& reg, std::uint8_t& flags)
	{
	...
	// 2 16
	// Z 0 0 C
	void lr35902::op_rrc_hl(std::uint8_t& flags)
	{
	...
	// 2 8
	// Z 0 0 C
	void lr35902::op_rl_r8(std::uint8_t& reg, std::uint8_t& flags)
	{
	...
	// 2 16
	// Z 0 0 C
	void lr35902::op_rl_hl(std::uint8_t& flags)
	{
	...
	// 2 8
	// Z 0 0 C
	void lr35902::op_rr_r8(std::uint8_t& reg, std::uint8_t& flags)
	{
	...
	// 2 16
	// Z 0 0 C
	void lr35902::op_rr_hl(std::uint8_t& flags)
	{
	...
	// 2 8
	// Z 0 0 C
	void lr35902::op_sla_r8(std::uint8_t& reg, std::uint8_t& flags)
	{
	...
	// 2 8
	// Z 0 0 C
	void lr35902::op_sla_hl(std::uint8_t& flags)
	{
	...
	// 2 8
	// Z 0 0 C
	void lr35902::op_sra_r8(std::uint8_t& reg, std::uint8_t& flags)
	{
	...
	// 2 8
	// Z 0 0 0
	void lr35902::op_swap_r8(std::uint8_t& reg, std::uint8_t& flags)
	{
	...
	// 2 16
	// Z 0 0 0
	void lr35902::op_swap_hl(std::uint8_t& flags)
	{
		std::uint16_t addr = get_register(r16::HL);
	...
	// 2 8
	// Z 0 0 C
	void lr35902::op_srl_r8(std::uint8_t& reg, std::uint8_t& flags)
	{
		right_shift_u8(reg, flags);
	}
	...
	// 2 16
	// Z 0 0 C
	void lr35902::op_srl_hl(std::uint8_t& flags)
	{
	...
	// 2 8
	// Z 0 1 -
	void lr35902::op_bit_r8(std::uint8_t bit, std::uint8_t& reg, std::uint8_t& flags)
	{
	...
	// 2 16
	// Z 0 1 -
	void lr35902::op_bit_hl(std::uint8_t bit, std::uint8_t& flags)
	{
	...
	// 2 8
	// - - - -
	void lr35902::op_res_r8(std::uint8_t bit, std::uint8_t& reg)
	{
		reg &= ~bit;
	}
	...
	// 2 8
	// - - - -
	void lr35902::op_set_r8(std::uint8_t bit, std::uint8_t& reg)
	{
		reg |= bit;
	}
